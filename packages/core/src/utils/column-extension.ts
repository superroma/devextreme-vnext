...
export function mapColumnExtensions(extensions: SortingColumnExtension[] | undefined) {
  if (!extensions || !extensions.length) return new Map<string, SortingColumnExtension>()
